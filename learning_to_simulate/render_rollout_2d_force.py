...
def main(unused_argv):
  ...
  for ax_i, (label, rollout_field) in enumerate(
    ...
    # a = rollout_data[rollout_field + 'forces'].reshape(314,3)
    # b = rollout_data["initial_forces"].reshape(7,3)
    # print(rollout_data[rollout_field + 'forces'].shape)
    # print(rollout_data["initial_forces"].shape)

    #mlpmixer
    # a = rollout_data[rollout_field + 'forces'].reshape(306,3)
    # b = rollout_data["initial_forces"].reshape(15,3)
