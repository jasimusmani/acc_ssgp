...
def main(unused_argv):
  ...
  for ax_i, (label, rollout_field) in enumerate(
    ...
    if FLAGS.fullspace:
      ...
      particles_nonrigid_full =  4880 #W.shape[0]
      ...
      trajectory = X
      print('2d to 3d', trajectory.shape)
