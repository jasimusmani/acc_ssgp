...
#     feat_train = np.load('data/pos_all_train_final.npy')
#     edges_train = np.load('data/edges_train_ssgp.npy')
#     feat_valid = np.load('data/pos_valid.npy')
#     edges_valid = np.load('data/edges_valid_ssgp.npy')
#     feat_test = np.load('data/pos_test.npy')
#     edges_test = np.load('data/edges_test_ssgp.npy')
...
def load_data_nri(batch_size=1):
    loc_train = np.load('data/pos_train_15' + '.npy')
    vel_train = np.load('data/vel_train_15' + '.npy')
    edges_train = np.load('data/edges_train_15' + '.npy')

    loc_train = loc_train[:, 2:, :15, :]
    vel_train = vel_train[:, :, :15, :]
    edges_train = edges_train[:, :15, :15]

    loc_valid = np.load('data/pos_valid_15' + '.npy')
    vel_valid = np.load('data/vel_valid_15' + '.npy')
    edges_valid = np.load('data/edges_valid_15' + '.npy')

    loc_valid = loc_valid[:, 2:, :15, :]
    vel_valid = vel_valid[:, :, :15, :]
    edges_valid = edges_valid[:, :15, :15]
    # loc_valid = loc_train
    # vel_valid = vel_train
    # edges_valid = edges_train

    loc_test = np.load('data/pos_test_15' + '.npy')
    vel_test = np.load('data/vel_test_15' + '.npy')
    edges_test = np.load('data/edges_test_15' + '.npy')

    loc_test = loc_test[:, 2:, :15, :]
    vel_test = vel_test[:, :, :15, :]
    edges_test = edges_test[:, :15, :15]
    # loc_test = loc_train
    # vel_test = vel_train
    # edges_test = edges_train
...
def load_data(batch_size=1, suffix='_springs5'):
