# Code adapted from https://github.com/ethanfetaya/NRI
import time
import argparse
import pickle
import os
...
parser = argparse.ArgumentParser(
    'Neural relational inference for predicting PCA modes interaction')
parser.add_argument('--num-residues', type=int, default=8,
                    help='Number of particles in the trajectory dataset.')
parser.add_argument('--save-folder', type=str, default='new_logs_excav_2',
                    help='file location to save the model')
parser.add_argument('--load-folder', type=str, default='',
                    help='load the trained model if finetunning. '
...
parser.add_argument('--timesteps', type=int, default=319,
...
# load data
train_loader, valid_loader, test_loader, loc_max, loc_min, vel_max, vel_min = load_data_nri(args.batch_size)
